...
set id 118
set name conv2D_mux_255_32cud_x
...
set out_width 11
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {11 1 +} m {11 1 +} i2 {11 0 +} p {11 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 5
set exp i0*i1+i2
set arg_lists {i0 {5 1 +} i1 {5 1 +} m {5 1 +} i2 {5 0 +} p {5 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename out_data \
    op interface \
    ports { out_data_address0 { O 14 vector } out_data_ce0 { O 1 bit } out_data_we0 { O 1 bit } out_data_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename kernel \
    op interface \
    ports { kernel_address0 { O 10 vector } kernel_ce0 { O 1 bit } kernel_q0 { I 32 vector } } \
} "
} else {

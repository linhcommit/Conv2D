...
// ==============================================================
#ifndef __conv2D_mul_mul_8ncud__HH__
#define __conv2D_mul_mul_8ncud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv2D_mul_mul_8ncud) {
    ...
    SC_CTOR(conv2D_mul_mul_8ncud):  ACMP_smul_us_U ("ACMP_smul_us_U") {

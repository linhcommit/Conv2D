# ==============================================================
# File generated on Thu Dec 19 01:58:33 +0700 2024
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "conv2D.autotvin.dat"
	set constFileTvOut       "conv2D.autotvout.dat"
	set constFileHdlTvIn     "conv2D.autohdltvin.dat"
	set constFileHdlTvOut    "conv2D.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

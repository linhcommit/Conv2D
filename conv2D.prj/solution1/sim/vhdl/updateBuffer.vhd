...
architecture behav of updateBuffer is 
    ...
    signal tmp_reg_290 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_9_fu_230_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_17_cast_fu_248_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_10_fu_257_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_14_fu_261_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp1_cast_fu_220_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_8_fu_224_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_265_p4 : STD_LOGIC_VECTOR (14 downto 0);
    signal grp_fu_265_p0 : STD_LOGIC_VECTOR (14 downto 0);
    signal grp_fu_265_p1 : STD_LOGIC_VECTOR (14 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_6_fu_209_p2 = ap_const_lv1_0) and (tmp_2_reg_296 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    buffer_r_address0_assign_proc : process(ap_CS_fsm_state3, ap_CS_fsm_state5, ap_CS_fsm_state4, tmp_9_fu_230_p1, tmp_10_fu_257_p1, tmp_14_fu_261_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            buffer_r_address0 <= tmp_14_fu_261_p1(5 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            buffer_r_address0 <= tmp_10_fu_257_p1(5 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            buffer_r_address0 <= tmp_9_fu_230_p1(5 - 1 downto 0);
        else 
    ...
    buffer_r_we0_assign_proc : process(tmp_2_reg_296, ap_CS_fsm_state5, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or ((tmp_2_reg_296 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5)))) then 
    ...
    grp_fu_265_p0 <= index_row_out(15 - 1 downto 0);
    grp_fu_265_p1 <= ik_row_reg_124(15 - 1 downto 0);
    grp_fu_265_p2 <= ap_const_lv15_64(8 - 1 downto 0);
    ...
    in_data_address0 <= tmp_17_cast_fu_248_p1(14 - 1 downto 0);
    ...
    tmp1_cast_fu_220_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ik_col_1_fu_214_p2),32));
        tmp_10_fu_257_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_s_reg_331),64));

    tmp_13_fu_252_p2 <= std_logic_vector(unsigned(tmp_reg_290) + unsigned(phi_mul_reg_136));
        tmp_14_fu_261_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_13_reg_341),64));

        tmp_17_cast_fu_248_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(grp_fu_265_p4),64));
    ...
    tmp_6_fu_209_p2 <= "1" when (signed(ik_col_cast_fu_205_p1) < signed(tmp_reg_290)) else "0";
    tmp_8_fu_224_p2 <= std_logic_vector(unsigned(tmp1_cast_fu_220_p1) + unsigned(phi_mul_reg_136));
        tmp_9_fu_230_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_8_fu_224_p2),64));

    tmp_fu_163_p2 <= std_logic_vector(signed(ap_const_lv32_FFFFFFFF) + signed(kernel_size_col));
    tmp_s_fu_235_p2 <= std_logic_vector(unsigned(ik_col_cast_fu_205_p1) + unsigned(phi_mul_reg_136));
end behav;

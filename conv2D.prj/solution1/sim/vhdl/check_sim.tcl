...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.conv2D.autotvin_in_data.dat"
         "c.conv2D.autotvin_out_data.dat"
         "c.conv2D.autotvin_row_in.dat"
         "c.conv2D.autotvin_col_in.dat"
         "c.conv2D.autotvin_kernel.dat"
         "c.conv2D.autotvin_kernel_size_row.dat"
         "c.conv2D.autotvin_kernel_size_col.dat"
         "c.conv2D.autotvout_out_data.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.conv2D.autotvout_out_data.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

...
$(ObjDir)/conv2D_test.c_pre.c.tb.o : conv2D_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) conv2D_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/conv2D.c_pre.c.tb.o : conv2D.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) conv2D.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

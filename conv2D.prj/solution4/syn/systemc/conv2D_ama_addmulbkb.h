...
// ==============================================================
#ifndef __conv2D_ama_addmulbkb__HH__
#define __conv2D_ama_addmulbkb__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv2D_ama_addmulbkb) {
    ...
    SC_CTOR(conv2D_ama_addmulbkb):  simcore_ama_0_U ("simcore_ama_0_U") {

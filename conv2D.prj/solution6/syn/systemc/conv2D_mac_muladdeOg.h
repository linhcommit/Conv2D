...
// ==============================================================
#ifndef __conv2D_mac_muladdeOg__HH__
#define __conv2D_mac_muladdeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv2D_mac_muladdeOg) {
    ...
    SC_CTOR(conv2D_mac_muladdeOg):  simcore_mac_1_U ("simcore_mac_1_U") {

...
set C_modelArgMapList {[ 
	{ "Name" : "buffer_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "index_col_out", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ index_col_out sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "index_col_out", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "index_col_out", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "8", "Max" : "251"}
	, {"Name" : "Interval", "Min" : "8", "Max" : "251"}
]}
...
set Spec2ImplPortList { 
	...
	index_col_out { ap_none {  { index_col_out in_data 0 32 } } }

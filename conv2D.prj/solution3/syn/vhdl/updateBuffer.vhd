...
architecture behav of updateBuffer is 
    ...
    signal tmp_3_fu_183_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_3_reg_302 : STD_LOGIC_VECTOR (14 downto 0);
    signal next_mul_fu_187_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal next_mul_reg_307 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal ik_row_1_fu_201_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ik_row_1_reg_315 : STD_LOGIC_VECTOR (30 downto 0);
    signal ik_col_1_fu_216_p2 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal ik_row_reg_126 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal phi_mul_reg_138 : STD_LOGIC_VECTOR (31 downto 0);
    signal ik_col_reg_150 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal index_col_out_cast_fu_161_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_171_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ik_row_cast_fu_192_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ik_col_cast_fu_207_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp1_cast_fu_222_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    ik_col_reg_150_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
                ik_col_reg_150 <= ik_col_1_reg_323;
            elsif (((tmp_4_fu_196_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                ik_col_reg_150 <= ap_const_lv31_0;
            end if; 
        end if;
    end process;

    ik_row_reg_126_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_6_fu_211_p2 = ap_const_lv1_0) and (tmp_2_reg_298 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_6_fu_211_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                tmp_s_reg_333 <= tmp_s_fu_237_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, ap_CS_fsm_state3, tmp_6_fu_211_p2, tmp_4_fu_196_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((tmp_4_fu_196_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
            when ap_ST_fsm_state3 => 
                if (((tmp_6_fu_211_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, tmp_4_fu_196_p2)
    begin
        if ((((tmp_4_fu_196_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2)) or ((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, tmp_4_fu_196_p2)
    begin
        if (((tmp_4_fu_196_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_fu_267_p0 <= index_row_out(15 - 1 downto 0);
    grp_fu_267_p1 <= ik_row_reg_126(15 - 1 downto 0);
    grp_fu_267_p2 <= ap_const_lv15_64(8 - 1 downto 0);
    ik_col_1_fu_216_p2 <= std_logic_vector(unsigned(ik_col_reg_150) + unsigned(ap_const_lv31_1));
    ik_col_cast_fu_207_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ik_col_reg_150),32));
    ik_row_1_fu_201_p2 <= std_logic_vector(unsigned(ik_row_reg_126) + unsigned(ap_const_lv31_1));
    ik_row_cast_fu_192_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ik_row_reg_126),32));
    ...
    index_col_out_cast_fu_161_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(index_col_out),32));
    next_mul_fu_187_p2 <= std_logic_vector(unsigned(phi_mul_reg_138) + unsigned(kernel_size_col));
    tmp1_cast_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ik_col_1_fu_216_p2),32));
        tmp_10_fu_259_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_s_reg_333),64));

    tmp_13_fu_254_p2 <= std_logic_vector(unsigned(tmp_reg_292) + unsigned(phi_mul_reg_138));
    ...
    tmp_1_fu_171_p2 <= std_logic_vector(unsigned(kernel_size_col) + unsigned(index_col_out_cast_fu_161_p1));
    tmp_2_fu_177_p2 <= "1" when (signed(tmp_1_fu_171_p2) < signed(col_in)) else "0";
    tmp_3_fu_183_p1 <= tmp_1_fu_171_p2(15 - 1 downto 0);
    tmp_4_fu_196_p2 <= "1" when (signed(ik_row_cast_fu_192_p1) < signed(kernel_size_row)) else "0";
    tmp_6_fu_211_p2 <= "1" when (signed(ik_col_cast_fu_207_p1) < signed(tmp_reg_292)) else "0";
    tmp_8_fu_226_p2 <= std_logic_vector(unsigned(tmp1_cast_fu_222_p1) + unsigned(phi_mul_reg_138));
        tmp_9_fu_232_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_8_fu_226_p2),64));

    tmp_fu_165_p2 <= std_logic_vector(signed(ap_const_lv32_FFFFFFFF) + signed(kernel_size_col));
    tmp_s_fu_237_p2 <= std_logic_vector(unsigned(ik_col_cast_fu_207_p1) + unsigned(phi_mul_reg_138));
end behav;

...
set out_width 15
set exp (i0+i1)*i2+i3
set arg_lists {i0 {15 0 +} i1 {15 0 +} s {15 1 +} i2 {8 0 +} m {15 1 +} i3 {15 0 +} p {15 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buffer_r \
    op interface \
    ports { buffer_r_address0 { O 5 vector } buffer_r_ce0 { O 1 bit } buffer_r_we0 { O 1 bit } buffer_r_d0 { O 32 vector } buffer_r_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_index_col_out \
    op interface \
    ports { index_col_out { I 31 vector } } \
} "
}
